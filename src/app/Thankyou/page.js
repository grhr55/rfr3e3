...
export default function Tencu() {
 ...
 <a  href="/" className=" w-[295px] py-[20px]  ml-32 mt-[30px] px-[30px] cursor-pointer  h-[87px] font-black rounded-[11px]  bg-[url(/img/fe.png)] bg-no-repeat text-white text-[22px] shadow-[inset_0_4px_12px_0_rgba(0,0,0,0.45)]">
           Вернуться на сайт
        </a>
